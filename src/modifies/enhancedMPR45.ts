...
export default function enhancedMPR45(logger:ILogger,itemHelper:ItemHelper,tables: IDatabaseTables): void {
  ...
  */
  ...
  const item5a71e4f48dc32e001207fb26 = tables.templates.items[ItemTpl.RECEIVER_GLOCK_ZEV_TECH_HEX_SPARTAN_RMR_PISTOL_SLIDE] || null;
  if(item5a71e4f48dc32e001207fb26){
    for (const slot of item5a71e4f48dc32e001207fb26._props.Slots) {
      if(slot._name!=='mod_scope'){continue;}
      slot._props.filters[0].Filter.push(
        ItemTpl.COLLIMATOR_VOMZ_PILAD_TARGETRING_REFLEX_SIGHT
      );
      break;
    }
  }
