...
export default function modifyBaseClassAssaultCarbine(logger:ILogger,itemHelper:ItemHelper,tables: IDatabaseTables): void {
  const idArray = itemHelper.getItemTplsOfBaseType(BaseClasses.ASSAULT_CARBINE);
