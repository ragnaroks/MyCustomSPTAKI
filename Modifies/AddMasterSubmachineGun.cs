...
public class AddMasterSubmachineGun : IOnLoad {
    ...
    private MongoId BaseId { get; } = new("6a08f9ed1b820ddcca2db400");
    private MongoId NewId { get; } = new("6a08f9ed1b820ddcca2db401");
    private MongoId RotateId { get; set; } = new("6a08f9ed1b820ddcca2db420");
    private MongoId OriginTemplateId { get; } = ItemTpl.SMG_TDI_KRISS_VECTOR_GEN2_9X19_SUBMACHINE_GUN;
            ...
            Properties = new() {
                Filters = [
                    new(){
                        Shift = 0,
                        Filter = [
                            ItemTpl.BARREL_KRISS_VECTOR_9X19_5_INCH,
                            ItemTpl.BARREL_KRISS_VECTOR_9X19_6_INCH
                        ]
                    }
                ]
            }
